...
const Profile: React.FC<MyComponentProps> = ({ /* Destructure props here */ }) => {
    return(
        <div className=" flex flex-col space-y-[10px]">
            <div className="flex flex-col space-y-[20px] sm:items-stretch items-center">
                ...
                <div className=" grid sm:grid-cols-3 grid-cols-1 gap-6 ">
                    ...
                    <Skill imageSrc="/spring.png" language="Spring" level="Intermediate" color="bg-[#3239c7]"
                     experience="3+ years of experience. "/>
                      <Skill imageSrc="flutter.png" language="Flutter" level="Intermediate" color="bg-[#ed7824]"
            ...
            <div className="flex flex-col space-y-[20px] sm:items-stretch items-center">
                ...
                <Skill imageSrc="/cotis.jpeg" language="Cotis ltd" level="Paid job" color="bg-[#0fdb42]"
                  ...
                  <Skill imageSrc="/pivot" language="Pivot Rwanda" level="Paid job" color="bg-[#0fdb42]"
                    experience="Full-stack developer"/>   
                </div>
            </div>
            <div className="flex flex-col space-y-[40px] sm:items-stretch items-center">
                <h1 className="text-2xl font-bold underline underline-offset-8
